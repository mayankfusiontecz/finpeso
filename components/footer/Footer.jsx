...
export default function Footer() {
    return (
        <div className="flex flex-row gap-[6rem] max-lg:gap-[2rem] px-15 bg-[#061E42] max-md:flex-col bg-[url('/assets/background/footer.png')] bg-cover bg-center">
            ...
            <div className="flex py-10 gap-[5rem] max-lg:gap-[3rem] items-start justify-evenly text-[white] pr-5 max-md:p-[1rem]">
                ...
                <ul className="flex flex-col items-center self-center justify-center gap-3">
