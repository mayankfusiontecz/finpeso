...
export default function Footer() {
    return (
        <div className="flex flex-row justify-evenly max-lg:gap-[2rem] px-15 bg-[#061E42] max-md:flex-col bg-[url('/assets/background/footer.png')] bg-cover bg-center max-md:gap-[2rem]">
            <div className="flex flex-col gap-5 w-[28%] px-[1.5rem] py-[1.5rem] max-md:items-center max-md:justify-center max-md:text-center max-md:w-[100%] max-md:mx-[0%]">
