            ...
            <div className="grid grid-cols-3 gap-[40px] items-center justify-center mt-[1rem] max-md:hidden"  data-aos="fade-right" data-aos-duration="1100">
                {
                    props.items1.map((box, index)=>(
                        <div key={index} className="flex flex-col items-center gap-5 px-[0.5rem] py-[2rem] text-center bg-[#EAF9FF] rounded-xl h-[320px] w-[350px] max-lg:h-[250px] max-lg:w-[220px] transition-transform duration-500 transform perspective-1000 hover:rotate-y-180"  data-aos="zoom-in-down">
            ...
            <div className="grid grid-cols-2 gap-[40px] items-center justify-center mt-[0.5rem] max-md:hidden" >
                {
                    props.items2 && (props.items2.map((box, index)=>(
                        <div key={index} className="flex flex-col items-center gap-5 px-[0.5rem] py-[2rem] text-center bg-[#EAF9FF] rounded-xl h-[320px] w-[350px] max-lg:h-[250px] max-lg:w-[220px]"  data-aos="zoom-in-down">
