...
export default function Cards (props){
    ...
    return(
        <>
        <div className="flex flex-col gap-5 items-center px-[3rem] overflow-hidden max-md:text-center max-lg:px-[1rem]" data-aos="fade-up" data-aos-duration="1000">
            ...
            <div className="grid grid-cols-3 gap-[40px] items-center justify-center mt-[1rem] max-md:hidden"  data-aos="fade-right" data-aos-duration="1100">
                {
                    props.items1.map((box, index)=>(
                        <div key={index} className="flex flex-col items-center gap-5 px-[0.5rem] py-[2rem] text-center bg-[#EAF9FF] rounded-xl h-[320px] w-[420px] max-lg:h-[250px] max-lg:w-[250px] transition-transform duration-500 transform perspective-1000 hover:rotate-y-180"  data-aos="zoom-in-down">
                            <img src={box.img} alt="security icon" className='max-lg:w-[20%]'/>
            ...
            <div className="grid grid-cols-2 gap-[40px] items-center justify-center mt-[0.5rem] max-md:hidden" >
                {
                    props.items2 && (props.items2.map((box, index)=>(
                        <div key={index} className="flex flex-col items-center gap-5 px-[0.5rem] py-[2rem] text-center bg-[#EAF9FF] rounded-xl h-[320px] w-[350px] max-lg:h-[250px] max-lg:w-[250px] "  data-aos="zoom-in-down">
