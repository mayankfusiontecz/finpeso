...
export default function HeroSection(){
    ...
    return(
            <div className={style['backgroundImage']}>
                ...
                <div className="flex items-center justify-between gap-[5rem] py-[3%] px-[8%] max-md:gap-1 max-md:px-[3%] max-md:pb-[25%] max-md:pt-[20%] max-lg:pt-[15%] max-lg:pb-[20%]">
                    <div className="pt-5 w-[60%]">
                            <h1 className="text-[2.5rem] text-white font-bold w-[80%] max-md:text-[1.2rem] max-lg:text-[1.5rem]">FINPESO - AI THAT SIMPLIFIES YOUR FINANCES</h1>
                        ...
                        <p  className="text-[2.5rem] text-[#1EC9E4] font-bold w-[80%] animate-fade max-md:text-[1rem] max-lg:text-[1.2rem]">{fullText}</p>
                    </div>
