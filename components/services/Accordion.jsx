...
export default function Accordion(props) {
    ...
    return (
        <div className="flex flex-col items-center justify-center mb-8">
            ...
            <div className="flex flex-col gap-8 justify-center px-[10%] w-screen max-md:px-[1%] " data-aos="fade-down" data-aos-delay='400'>
                {props.accordionData.map((item,index) => (
                    <div key={index} className={`flex flex-col border border-white rounded-xl shadow-lg p-4 ${openAccordion === index ? 'bg-[#E0ECFD]' : ''}`}>
                        ...
                        {openAccordion === index && (
                            ...
                            <>
                                <ul className='w-[80%] text-[0.8rem] list-disc pl-5 mt-5'>
                                    {
