...
export default function PhoneTextbg(props){
    ...
    return(
        <div className="flex justify-between px-[8%] gap-[5rem] bg-[url('/assets/background/fourthbg.png')] h-[100%] bg-cover bg-center">
                {/* {
                props.img1?(
                    ...
                    :
                    ( */}
                        <div  className='flex justify-center items-end w-[30%] py-[3rem]' data-aos="zoom-in">
                            <img src={props.image1} alt='phone 1' className=''/>
                        </div>
                    {/* )
                } */}
            <div className='flex flex-col justify-center gap-2 text-white items-start w-[60%]' data-aos="zoom-in-up">
