        ...
        <div className='flex flex-col justify-center gap-8 items-center'>
            ...
            <div className='flex justify-between gap-0 bg-[#F2FEFE] px-[2rem] w-[100%] max-md:p-[1rem] max-md:gap-[1rem]  rounded-xl max-md:w-[90%] max-md:items-end max-md:justify-center'>
                <div className='flex relative ml-12 w-[30%] max-md:ml-2 max-md:h-[30%] max-md:bottom-0 max-md:w-0' data-aos="fade-up-right">
                    <img src={thirdcomp1.src} alt='best money tracking app' className="max-md:mb-[-1rem] max-md:hidden"/>
                </div>
            ...
            <div className='flex justify-center gap-[5rem] mx-[4rem] max-md:flex-col max-md:px-[1rem] max-md:mx-0 max-md:items-center max-md:gap-8'>
                <div className='bg-[#F2FEFE] w-[50%] p-8 rounded-xl  max-md:w-[95%] max-md:px-[1rem]' data-aos="fade-right">
                    <img src={thirdicon1.src} alt='AI-Powered Expense Management' />
                ...
                <div className="w-[50%] p-8 rounded-xl bg-[#001027] overflow-hidden max-md:w-[95%] max-md:mx-0 max-md:px-[1rem]" data-aos="fade-left">
                    <img src={thirdicon2.src} alt='best budget planner app' />
                    ...
                    <img src={thirdcomp3.src} alt='monthly budget app' className='mb-[-100%] h-[100%] max-md:h-[80%] max-lg:w-[90%]' />
                </div>
            </div>
            <div className='flex justify-center gap-5 mx-[5rem] max-md:flex-col max-md:mx-0 max-md:items-center max-md:px-[1rem]'>
                ...
                <div className='w-[40%] bg-[#F2FEFE] rounded-xl p-8 relative  max-md:w-[95%] max-md:px-[1rem]' data-aos="flip-left">
                    ...
                    <img src={props.card5.bottomimg} alt='best budgeting app canada' className='absolute bottom-0 right-0 w-[250px] z-10 h-auto  max-md:w-[150px]' />
                </div>
                <div className='w-[40%] bg-[#71D5EC] rounded-xl p-8 pb-0 max-md:w-[95%] max-md:px-[1rem]' data-aos="flip-left">
                    ...
                    <img src={props.card6.img} alt='personal finance tracker' className='bottom-0 w-[20vw] mt-[2rem] max-md:w-[60vw]' />
                </div>
            </div>
        </div>
    )
