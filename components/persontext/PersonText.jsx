...
export default function PersonText(props){
    ...
    return(
        <div className='flex justify-center items-center mt-8 gap-[8rem] bg-[url("/assets/background/fourthbg.png")] bg-cover bg-center max-lg:gap-[5rem]'>
            <div className='mt-[-5%] w-[40%] mt-auto bottom-0 max-md:hidden' data-aos="fade-right">
            <img src={props.img} alt='expense tracking app canada'/>
            </div>
