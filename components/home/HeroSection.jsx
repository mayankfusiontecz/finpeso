...
export default function HeroSection() {
    ...
    return (
        <div className={style['backgroundImage']}>
            ...
            <div className="flex items-center justify-center gap-[8rem] py-[3%] px-[8%] max-md:gap-1 max-md:px-[3%]">
                <div className="pt-5">
                    ...
                    <div className="w-[90%] mt-5">
                        <h1 className="text-[2.5rem] text-white font-bold max-md:text-[1.2rem]">WELCOME TO FINPESO – YOUR PERSONAL</h1>
                        {text.split("").map((char, index) => (
                            <motion.span
                                ...
                                transition={{
                                 ...
                                 className="text-[2.5rem] text-[#1EC9E4] font-bold w-[80%] max-md:text-[1.2rem]"
                            >
                                {char === " " ? "\u00A0" : char}
                            </motion.span>
                        ))}
